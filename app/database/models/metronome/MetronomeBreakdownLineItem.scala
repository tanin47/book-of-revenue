...
case class MetronomeBreakdownLineItem(
  id: String,
...
class MetronomeBreakdownLineItemTable(tag: Tag) extends Table[MetronomeBreakdownLineItem](tag, Some("metronome"), "breakdowns_line_items") {
  ...
  def * : ProvenShape[MetronomeBreakdownLineItem] = (
    id ::
    environmentType ::
    snapshotTimestamp ::
    watermarkTimestamp ::
    ...
    updatedAt ::
      HNil
  ).mapTo[MetronomeBreakdownLineItem]
}
