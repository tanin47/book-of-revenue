...
case class StripeSubscriptionItem(
...
case class RichStripeSubscriptionItem(
  base: StripeSubscriptionItem,
  subscription: RichStripeSubscription,
...
class StripeSubscriptionItemTable(tag: Tag) extends Table[StripeSubscriptionItem](tag, Some("stripe"), "subscription_item") {
  ...
  def * : ProvenShape[StripeSubscriptionItem] = (
    stripeAccountId,
    liveMode,
    id,
    subscriptionId,
