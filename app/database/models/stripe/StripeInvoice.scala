...
import framework.TransactionDetail.BillingActivity.{FinalizeInvoice, MarkUncollectibleInvoice, VoidInvoice}
...
case class RichStripeInvoice(
  base: StripeInvoice,
  lineItems: Seq[RichStripeInvoiceLineItem],
  payments: Seq[RichStripeInvoicePayment],
  customerBalanceTransactions: Seq[StripeCustomerBalanceTransaction],
  creditNotes: Seq[RichStripeCreditNote],
...
class StripeInvoiceTable(tag: Tag) extends Table[StripeInvoice](tag, Some("stripe"), "invoice") {
