...
case class RichStripeInvoiceItem(
  base: StripeInvoiceItem,
...
class StripeInvoiceItemTable(tag: Tag) extends Table[StripeInvoiceItem](tag, Some("stripe"), "invoice_item") {
  ...
  def * : ProvenShape[StripeInvoiceItem] = (
    stripeAccountId,
    liveMode,
    id,
    invoiceId,
