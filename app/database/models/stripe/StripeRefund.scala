...
case class RichStripeRefund(
  base: StripeRefund,
  balanceTransaction: Option[StripeBalanceTransaction],
  failureBalanceTransaction: Option[StripeBalanceTransaction],
...
class StripeRefundTable(tag: Tag) extends Table[StripeRefund](tag, Some("stripe"), "refund") {
