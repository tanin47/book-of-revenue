...
case class RichStripePrice(
  base: StripePrice,
  product: Option[StripeProduct],
  tiers: Seq[StripePriceTier]
) extends Jsonable {
...
class StripePriceTable(tag: Tag) extends Table[StripePrice](tag, Some("stripe"), "price") {
