...
case class StripeInvoicePayment(
...
case class RichStripeInvoicePayment(
  base: StripeInvoicePayment,
...
class StripeInvoicePaymentTable(tag: Tag) extends Table[StripeInvoicePayment](tag, Some("stripe"), "invoice_payment") {
  ...
  def * : ProvenShape[StripeInvoicePayment] = (
    stripeAccountId,
    liveMode,
    id,
    amountPaid,
