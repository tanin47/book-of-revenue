...
class StripeCreditGrantTable(tag: Tag) extends Table[StripeCreditGrant](tag, Some("stripe"), "credit_grant") {
  ...
  def * : ProvenShape[StripeCreditGrant] = (
    stripeAccountId,
    liveMode,
    id,
    customer,
