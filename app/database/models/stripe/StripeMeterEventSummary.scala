...
case class StripeMeterEventSummary(
...
class StripeMeterEventSummaryTable(tag: Tag) extends Table[StripeMeterEventSummary](tag, Some("stripe"), "meter_event_summary") {
  ...
  def * : ProvenShape[StripeMeterEventSummary] = (
    stripeAccountId,
    liveMode,
    id,
    aggregatedValue,
