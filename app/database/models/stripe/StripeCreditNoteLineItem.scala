...
case class StripeCreditNoteLineItem(
...
case class RichStripeCreditNoteLineItem(
  base: StripeCreditNoteLineItem,
  pretaxCreditAmounts: Seq[RichStripeCreditNoteLineItemPretaxCreditAmount],
  taxes: Seq[StripeCreditNoteLineItemTax],
) extends Jsonable {
  ...
  lazy val creditGrants: Seq[RichStripeCreditNoteLineItemPretaxCreditAmount] = pretaxCreditAmounts.filter(_.creditBalanceTransaction.exists(_.creditGrant.isDefined))
...
class StripeCreditNoteLineItemTable(tag: Tag) extends Table[StripeCreditNoteLineItem](tag, Some("stripe"), "credit_note_line_item") {
  ...
  def * : ProvenShape[StripeCreditNoteLineItem] = (
    stripeAccountId,
    liveMode,
    id,
    creditNoteId,
