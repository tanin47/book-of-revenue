...
export type Params = TableParams & {
  ...
  export const BASE_COLUMNS: ColumnSelectionItem[] = [
    ...
    {id: 'GrossRevenue', forceChecked: true, rank: 1},
    {id: 'CreditNotes', forceChecked: true, rank: 2},
    {id: 'Disputes', forceChecked: true, rank: 3},
    {id: 'Refunds', forceChecked: true, rank: 4},
    {id: 'Voids', forceChecked: true, rank: 5},
    {id: 'NetRevenue', forceChecked: true, rank: 6},
  ]

  export const COLUMNS: ColumnGroupBy[] = makeColumnGroupBys(['Summary', 'Product', 'Customer', 'Transaction', 'LineItem'], BASE_COLUMNS)
  ...
  export const SHOW_ONLYS: ShowOnly[] = [
    {id: 'GrossRevenue', label: 'Non-zero gross revenue'},
    {id: 'CreditNotes', label: 'Non-zero credit notes'},
    {id: 'Refunds', label: 'Non-zero refunds'},
    {id: 'Disputes', label: 'Non-zero disputes'},
    {id: 'Voids', label: 'Non-zero voids'},
    {id: 'NetRevenue', label: 'Non-zero net revenue'},
  ]
</script>
<script lang="ts">
    ...
    <div class="flex gap-2 items-center">
      ...
      <div>
        ...
        >
          ...
          {#each SHOW_ONLYS as {id, label} (id)}
