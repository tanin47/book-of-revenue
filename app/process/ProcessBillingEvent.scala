...
object ProcessBillingEvent {
  ...
  sealed abstract class JournalEntryEvent {
    ...
    def toJournalEntry(
      ...
      JournalEntry(
        ...
        stripeChargeId = reference.chargeId,
        stripeBalanceTransactionId = reference.balanceTransactionId,
        stripeDisputeId = reference.disputeId,
        stripeRefundId = reference.refundId,
        stripeCustomerBalanceTransactionId = None,
        stripePaymentIntentId = reference.paymentIntentId,
        stripePaymentRecordId = reference.paymentRecordId,
        stripeSubscriptionId = None,
        stripeSubscriptionItemId = None,
        stripeCreditBalanceTransactionId = None,
        stripeCreditNoteId = reference.creditNoteId,
  ...
  private[this] def bookCreditNoteVoided(
    ...
    val creditNoteEntries = entries.filter { e => e.stripeCreditNoteId.contains(creditNoteId) && e.stripeCreditNoteLineItemId == reference.creditNoteLineItemId }
